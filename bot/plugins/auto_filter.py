...
async def auto_filter(bot, update):
    ...
    if len(results) == 0: # double check
        ...
        # Just A Decaration
        result[0].append([
            InlineKeyboardButton(f"📰 𝙋𝘼𝙂𝙀𝙎 1/{len_result if len_result < max_pages else max_pages} 📰", callback_data="ignore")
        ])
